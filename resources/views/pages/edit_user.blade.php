...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">MODIFIER UN UTILISATEUR</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Modifier un nouveau utilisateur</h4>
                ...
                <form action="{{url('editUser')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('nom') is-invalid @enderror" name="nom" type="text" value="{{$user->nom}}" id="example-text-input">
                            @error('nom')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('prenom') is-invalid @enderror" name="prenom" type="text" value="{{$user->prenom}}" >
                            @error('prenom')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('tel') is-invalid @enderror" name="tel" type="tel" value="{{$user->tel}}" id="example-tel-input">
                            @error('tel')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @error('email') is-invalid @enderror" name="email" type="email" value="{{$user->email}}" id="example-email-input">
                            @error('email')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
